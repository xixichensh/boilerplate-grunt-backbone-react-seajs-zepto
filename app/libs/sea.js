...
// Load module.dependencies and fire onload when all done
    Module.prototype.load = function() {
        ...
        // Emit `load` event for plugins such as combo plugins
...
// Fetch a module
    Module.prototype.fetch = function(requestCache) {
        ...
        // Emit `fetch` event for plugins such as combo plugins
        ...
        // Emit `request` event for plugins such as text plugins
...
// Resolve id to uri
    Module.resolve = function(id, refUri) {
        // Emit `resolve` event for plugins such as text plugins
...
// Define a module
    Module.define = function (id, deps, factory) {
        ...
        // Emit `define` event, used in nocache plugins, seajs node version etc
        emit("define", meta)
